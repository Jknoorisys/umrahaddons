		...
		<tbody>
			<tr>
				<td class="" width="600" valign="top" align="left">
                  ...
                  <img src="<?=base_url('public/assets/logo/logo_web.png')?>" alt style="display: block;" width="250"></td>
							</tr>
							
              <tr>
                <td class="" bgcolor="" align="left" style="padding-top: 20px;">
                  <p>Dear Customer,</p>
                  <p> <b><?=$otp?></b> is your OTP, usable only once. Do not disclose it to anyone.</p>
                  <p> Contact our support team if it is not initiated by you.</p>
                </td>
            	</tr>
