            ...
            <tr>
                ...
                <tbody>
                    ...
                    <td class="" bgcolor="" align="left" style="padding-top: 20px;">
                        ...
                        <p>  Mr. <?=$user_name?> has has selected <?=$package_name?> Meals from our platform. Kindly provide the confirmation email.</p>
                    </td>
                    </tr>
        ...
        <tbody>
            <tr>
                ...
                <tbody>
                    ...
                    <tr>
                    <td class="" bgcolor="" align="left" style="padding-top: 20px;">
                        <p>Dear <?= $user_name ?>, Congratulations!</p>
                        <p>  We are pleased to confirm your reservation with <?=$provider_name?> provider. </p>
                        <p>  You’ll get the further updates from the provider through the registered email. </p>
                    </td>
                    </tr>
